...
function AddProduct() {
    ...
    const handlePreviewImg1 = (e)=> {
        setData({ ...data, image01: e.target.value })
                            ...
                            <tr>
                                ...
                                <td className={cx('product-table__img')}>
                                    <div className={cx('product-table__img__item')}>
                                        ...
                                        <input value={data.image01} name='img1' type="file" onChange={handlePreviewImg1}/>
                                        {img1 && <img src={img1.preview} alt="" />}
                                        </div>
    
                                    <div className={cx('product-table__img__item')}>
                                        <label htmlFor="">Ảnh 2 (nếu có):</label>
                                        <input  name='img2' type="file" onChange={handlePreviewImg2}/>
                                        {img2 && <img src={img2.preview} alt="" />}
                                    </div>
